...
async def get_phone(message: Message, state: FSMContext):
    ...
    text = (f"🎮 Yangi Akkaunt Sotuvda!\n\n"
            ...
            f"📞 Tel: {message.text}\n\n"
            f"➖➖➖➖➖➖➖➖➖➖\n"
            f"👨‍💻 Admin: skvunt sotib olishda sotishda oʻrtga turib berish @Azizku_2008\n"
...
async def admin_panel(message: Message):
    btn = InlineKeyboardMarkup(inline_keyboard=[
        ...
        # ===== BITTA KARTA =====
        [InlineKeyboardButton(text="💳 Karta raqamini o'zgartirish", callback_data="admin_card", style="danger")],
    ])
