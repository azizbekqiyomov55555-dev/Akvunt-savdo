...
async def admin_uc_list(call: CallbackQuery):
    ...
    for item in prices:
        ...
        rows.append([InlineKeyboardButton(text=f"🗑 {item['uc_amount']} UC o'chirish", callback_data=f"del_uc_price_{item['id']}", style="danger")])
...
async def admin_stars_list(call: CallbackQuery):
    ...
    for item in prices:
        ...
        rows.append([InlineKeyboardButton(text=f"🗑 {item['stars_amount']} Stars o'chirish", callback_data=f"del_stars_price_{item['id']}", style="danger")])
...
async def admin_premium_list(call: CallbackQuery):
    ...
    for item in prices:
        ...
        rows.append([InlineKeyboardButton(text=f"🗑 {item['duration']} o'chirish", callback_data=f"del_premium_price_{item['id']}", style="danger")])
