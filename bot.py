...
# ================== SOZLAMALAR ==================
BOT_TOKEN = "8674741228:AAGHzR8sfFTAW9N6BpYuVWusz_cIsxAqz_w"
ADMIN_ID = 8537782289
...
def init_db():
    with sqlite3.connect(DB_NAME) as conn:
        ...
        # Stars va Premium uchun ham o'sha karta (bitta karta)
...
async def admin_panel(message: Message):
    btn = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [
            InlineKeyboardButton(text="📋 Stars narxlari ro'yxati", callback_data="admin_stars_list", style="primary"),
        ...
        [
            InlineKeyboardButton(text="📋 Premium narxlari ro'yxati", callback_data="admin_premium_list", style="primary"),
            InlineKeyboardButton(text="📦 Premium buyurtmalar", callback_data="admin_premium_orders", style="primary"),
        ],
        # ===== UMUMIY KARTA =====
        [InlineKeyboardButton(text="💳 Stars/Premium Karta o'zgartirish", callback_data="admin_main_card", style="danger")],
    ])
